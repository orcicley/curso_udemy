...
"resource": {
  ...
  "macros":[{
      ...
      "function":"__jsm",
      "vtp_javascript":["template","(function(){return\"ja_JP\"==",["escape",["macro",6],8,16],"||\"ja-JP\"==",["escape",["macro",6],8,16],"||\"jp-JP\"==",["escape",["macro",6],8,16],"||\"jp_JP\"==",["escape",["macro",6],8,16],"})();"]
    },{
      "function":"__jsm",
  ...
  "tags":[{
      ...
      "vtp_dimension":["list",["map","index","16","dimension",["macro",16]]],
      ...
      "vtp_dimension":["list",["map","index","5","dimension",["macro",0]],["map","index","6","dimension","offerdetail"],["map","index","8","dimension",["macro",5]]],
      "vtp_enableEcommerce":false,
      "vtp_trackingId":["macro",20],
      "vtp_enableRecaptchaOption":false,
      "vtp_enableUaRlsa":false,
      ...
      "function":"__html",
      "once_per_event":true,
      "vtp_html":["template","\u003Cscript\u003Ewindow._fbq=window._fbq||[];_fbq.push([\"track\",\"Purchase\",{content_ids:",["escape",["macro",30],8,16],",content_type:\"product\",order_id:",["escape",["macro",31],8,16],",value:",["escape",["macro",2],8,16],",currency:\"USD\"}]);\u003C\/script\u003E"],
      "vtp_supportDocumentWrite":true,
      "vtp_enableIframeMode":false,
      "vtp_enableEditJsMacroBehavior":false,
      "vtp_usePostscribe":true,
      ...
      "once_per_event":true,
      "vtp_html":["template","\u003Cscript type=\"text\/gtmscript\"\u003Eire(\"trackConversion\",12148,{orderId:",["escape",["macro",35],8,16],",customerId:",["escape",["macro",36],8,16],",email:",["escape",["macro",37],8,16],",orderPromoCode:",["escape",["macro",38],8,16],",currencyCode:\"USD\",items:[{subTotal:",["escape",["macro",39],8,16],",category:",["escape",["macro",40],8,16],",sku:",["escape",["macro",41],8,16],",quantity:1}]});\u003C\/script\u003E"],
      "vtp_supportDocumentWrite":false,
      "vtp_enableIframeMode":false,
      "vtp_enableEditJsMacroBehavior":false,
      "tag_id":170
  ...
  "rules":[
    [["if",0,1],["add",1]],
    [["if",1,2],["add",2,3]],
    [["if",1,3],["unless",4,5],["add",4,5,26,94,106]],
    [["if",1,7,8],["add",6,7,10,75,76,77,82,83]],
    [["if",1,9],["add",8,14,15,17,18,32,48,49,73,88,89]],
    [["if",10,11],["add",8,17,35,46,52,54,57,58,73,86,90,107,109,110]],
    [["if",1,12],["add",9,80,81]],
    [["if",1,3,8],["add",11,30,33,42,51,93,99,104,111,112,114,115]],
    [["if",8,13],["add",12,13]],
    [["if",1,6],["add",16],["block",4,5,11,25,26,30,33,42,43,45,47,51,74,0,87,93,99,101,104,106,117,121]],
    [["if",1],["add",16,40,43,87,117,120,62,63,64,65,66,68,69,70,71,72]],
    [["if",14],["add",19,20,60]],
    [["if",15,16,17,18],["add",21]],
    [["if",15,17,18],["unless",16],["add",22]],
    [["if",1,19],["add",23]],
    [["if",1,21],["unless",20],["add",24,53,94]],
    [["if",22,23],["add",25]],
    [["if",18,24,25],["add",27,28]],
    [["if",13],["add",29,34,39,41]],
    [["if",8,10,11],["add",31,50,92,98,102,103,113],["block",114,115]],
    [["if",1,26],["add",32]],
    [["if",1,28],["add",36,96]],
    [["if",18,29,30],["add",37]],
    [["if",18,31],["add",38]],
    [["if",18,32,33],["add",44,97]],
    [["if",34,35],["add",45,79],["block",93]],
    [["if",1,3],["unless",4,27],["add",47,101,121]],
    [["if",1,43],["add",53,94]],
    [["if",1,44],["add",53]],
    [["if",1,38],["add",53,94],["block",47,101]],
    [["if",1,43,45],["add",53,94]],
    [["if",1,46],["add",53,94]],
    [["if",1,47],["add",53,94]],
    [["if",1,48],["add",53,94]],
    [["if",1,49],["add",53,94]],
    ...
    [["if",18,51],["add",55]],
    [["if",18,52],["add",56]],
    [["if",1,53],["add",59,94,94]],
    [["if",1,54],["add",61,105]],
    [["if",1,55],["add",67]],
    [["if",1,37],["add",74],["block",47,100,101,117,122]],
    [["if",1,56],["unless",57],["add",74]],
    [["if",58,59],["add",74]],
    [["if",1,61],["add",0]],
    [["if",35],["add",78]],
    [["if",1,63],["add",84]],
    ...
    [["if",1,67],["add",94]],
    [["if",1,68],["add",94]],
    [["if",1,39],["add",94],["block",47,101]],
    [["if",1,69],["add",94]],
    [["if",1,70],["add",94]],
    [["if",1],["unless",71],["add",94]],
    [["if",1,72],["add",94]],
    [["if",1,73],["add",94]],
    [["if",1,74],["add",94]],
    [["if",1,75],["add",94]],
    [["if",1,76],["add",94]],
    [["if",1,3,5],["unless",4],["add",94]],
    [["if",1,77],["unless",78,79],["add",94]],
    [["if",1,80],["add",94]],
    [["if",10,81],["add",95,116]],
    [["if",82,83,84,85],["add",100,108]],
    [["if",18,86],["add",119]],
    [["if",83,85,87],["add",122]],
    [["if",1,27],["block",33,74,0]],
    [["if",1,36],["block",47,101]],
    [["if",1,40],["block",47,100,101,117,122]],
    [["if",1,41],["block",47,100,101,117,122]],
    [["if",1,42],["block",47,100,101,117,122]],
    [["if",1,60],["block",74]],
    [["if",1,62],["block",0]]]
},
"runtime":[
